...
<head>
    ...
    <link href="{{url("admin")}}/css/authentication/form-1.css" rel="stylesheet" type="text/css" />
    <!-- END GLOBAL MANDATORY STYLES -->
    <link rel="stylesheet" type="text/css" href="{{url("admin")}}/css/forms/theme-checkbox-radio.css">
    <link rel="stylesheet" type="text/css" href="{{url("admin")}}/css/forms/switches.css">
</head>
<body class="form">
            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content">
                        ...
                        <p class="signup-link">New Here? <a href="admin_register.html">Create an account</a></p>
                        <form method="POST" action="{{url("login")}}" class="text-left">
                            ...
                            <div class="form">
                                ...
                                <div class="field-wrapper">
                                    <a href="admin_pass_recovery.html" class="forgot-pass-link">Forgot Password?</a>
                                </div>
    ...
    <script src="{{url("admin")}}/js/adminentication/form-1.js"></script>
