                    ...
                    <div claas="row">
                        ...
                        <div class="col-12">
                            <div class="banner-filter">
                                <form  action="{{url('parent/filter')}}"  class="filter-form">
                                    <div class="filter">
                                    ...
                                    <div class="filter">
                                        <select id="grade" name="type">
                                            ...
                                            <option value="Kindergarden">kinedergarden</option>
                                            <option value="Nursery">nursery</option>
                                        </select>
                                    </div>
                                    <div class="filter">
                                        <input id="inst" type="text" placeholder="Suggested Installments" name="installments">
                                    </div>
                                    <div class="filter">
                                        <select id="education" name="educational_system">
                                    ...
                                    <div class="filter-submit">
                                        <button id="filterBtn" type="button"><i class="fa-solid fa-magnifying-glass"></i></button>
                                    </div>
                                </form>
                            </div>
                        </div>
...
console.log("joijoioi");
    function addFilter(){
        let href = 'parent/filter?';

        let area = document.getElementById('area').value;
        let education = document.getElementById('education').value;
        let type = document.getElementById('grade').value;
        let install = document.getElementById('inst').value;
        ...
        if (area.length) {
         ...
         if (education.length) {
            href += "&filter[educational_system]=" + education;
         }
         if (type.length) {
         ...
         if (install.length) {
            href += "&filter[lessthanOrEqual]=" + install;
         }
...
let filter = $("#filterBtn").click(function(){
    addFilter();
});
